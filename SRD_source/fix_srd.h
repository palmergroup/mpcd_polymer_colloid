...
class FixSRD : public Fix {
 ...
 private:
  ...
  int smallexist, smallgroup, smallgroupbit;                         //JCP: Added for small particles
  int collidestyle,lamdaflag,overlap,insideflag,exactflag,maxbounceallow;
  int cubicflag,shiftuser,shiftseed,shiftflag,tstat, mpcdat;         //JCP: Added mpcdat flag
  ...
  int debugflag;                                                     //JCP: Added for debugging          

  double dt_big,dt_srd;
  double dt_smallv,dt_smallf;                                        //JCP: Added for NVE integration of small particles
  double mass_big,mass_srd; 
  double mass_small,sigma_small;                                     //JCP: Added for small particles
  ...
  int maxsmall;           // max number of owned/ghost small particles and walls 
  ...
  struct BinAve {
    ...
    int m;               // JCP: # of small particles in bin
    ...
    double linmom[3];    // JCP: linear momentum for debugginb purposes
  };
  ...
  void reset_velocities_small();                                     //JCP:  Function to reset velocities in the presence of small particles
  void vbin_comm(int);
